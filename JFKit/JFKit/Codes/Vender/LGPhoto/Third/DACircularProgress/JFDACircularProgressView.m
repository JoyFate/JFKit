...
#import "JFDACircularProgressView.h"

#import <QuartzCore/QuartzCore.h>

@interface JFDACircularProgressLayer : CALayer
...
@implementation JFDACircularProgressLayer
...
- (id)initWithLayer:(JFDACircularProgressLayer *)layer
{
...
@implementation JFDACircularProgressView

+ (void) initialize
{
    if (self != [JFDACircularProgressView class])
        return;
...
+ (Class)layerClass
{
    return [JFDACircularProgressLayer class];
}

- (JFDACircularProgressLayer *)circularProgressLayer
{
    return (JFDACircularProgressLayer *)self.layer;
}
