...
//    UIImage *retImage = [UIImage imageWithCIImage:outPutImage];
//    [retImage drawInRect:CGRectMake(0,0 , Imagesize, Imagesize)];
    
    return [JFImageTool createNonInterpolatedUIImageFormCIImage:outPutImage withSize:Imagesize waterImageSize:0];
}
